...
from django.core.files.base import ContentFile
from .models import Departments
from .types import DepartmentType  # Or wherever your Graphene type is defined
...
class CreateDepartment(graphene.Mutation):
    ...
    class Arguments:
        ...
        image = graphene.String(required=True)  # Base64 image string
    ...
    def mutate(self, info, name, image, lead):
        ...
        print("Name:", name)
        print("Lead:", lead)
        print("Image preview:", image[:50])  # Just to log part of it
