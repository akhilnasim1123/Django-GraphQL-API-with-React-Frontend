...
import { createDepartment } from '../Features/Authority';
...
function DepartmentsPage() {
    ...
    const [departments,setDepartments] = useSta
  ...
  const handleCreateDepartment = async (e) => {
    ...
    try {
      ...
      var departments = await dispatch(createDepartment({ name, image: base64Image, lead,user })).unwrap();
      departments.map((index,department)=>{
