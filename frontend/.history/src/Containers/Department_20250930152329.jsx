...
// Assuming Sidebar is available in the same directory or project structure
import Sidebar from './Sidebar'; 

// Define the theme colors
const ACCENT_COLOR = '#00bcd4';
const MAIN_BG = '#0b0b0b'; // Very dark background
const CARD_BG = '#1c1c1c'; // Darker gray for containers/cards
...
function DepartmentsPage() {
  return (
    <div className="d-flex" style={{ minHeight: '100vh', backgroundColor: MAIN_BG }}>

      <Sidebar /> 
      
      <main style={{ flexGrow: 1, color: TEXT_COLOR, padding: '2rem' }}>
