...
import { createDepartment, getDepartments, updateDepartment } from '../Features/Authority';
...
function DepartmentsPage() {
  ...
  const handleUpdateDepartment = async(e)=>{
    ...
    try{
        ...
        const department = await dispatch(updateDepartment({id,name,image:base64Image,lead})).unwrap();
        console.log(department)
        setDepartments(prev => [...prev, department]); 
        const modalEl = document.getElementById("createDepartmentModal");
        if (modalEl) {
                ...
                >
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content bg-dark text-white"> {/* Dark background and white text */}
                            ...
                            <form onSubmit={isUpdate ? handleUpdateDepartment :handleCreateDepartment}>
