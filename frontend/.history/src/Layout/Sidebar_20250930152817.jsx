...
function Sidebar() {
  ...
  const navItems = [ 
    ...
    { name: 'Departments', icon: 'bi-house-door-fill', active: false, redirect: '/Department' },
  ];
  ...
  const handleNavClick = (index, redirect) => {
    setActiveIndex(index);  // Update active nav item index
    navigate(redirect);     // Navigate to route
  };
