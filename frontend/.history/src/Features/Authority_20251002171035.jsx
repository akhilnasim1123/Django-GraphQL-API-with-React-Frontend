...
export const updateDepartment = createAsyncThunk(
  ...
  async ({id,name,image,lead},thunkAPI)=>{
    try{
      ...
      if (data?.updateDepartment?.department){
        return data.updateDepartment.department
      }else{
        return thunkAPI.rejectWithValue("Failed to update department")
      }
    }catch(error){
      return thunkAPI.rejectWithValue(error.message||"Mutation Faile")
    }
  }
)
