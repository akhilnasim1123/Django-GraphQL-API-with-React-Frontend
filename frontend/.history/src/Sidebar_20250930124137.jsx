...
function Sidebar() {
  ...
  const navItems = [
    ...
    { name: 'Analytics', icon: 'bi-speedometer2', active: false,redirect:'/dashboard'  },
    { name: 'Users', icon: 'bi-people-fill', active: false,redirect:'/dashboard'  },
    { name: 'Reports', icon: 'bi-file-earmark-bar-graph-fill', active: false,redirect:'/dashboard'  },
  ];
