...
function Sidebar() {
  ...
  // Navigation Items
  const navItems = [
    { name: 'Home', icon: 'bi-house-door-fill', active: true,redirect:'/dashboar' },
    { name: 'Analytics', icon: 'bi-speedometer2', active: false },
    { name: 'Users', icon: 'bi-people-fill', active: false },
    { name: 'Reports', icon: 'bi-file-earmark-bar-graph-fill', active: false },
  ];
