...
function HomePage() {
  // Define a modern, vibrant primary color for highlights
  const primaryColor = '#00bcd4'; 
  // A slightly lighter dark for the main background
  const mainBg = '#0b0b0b'; 
  // A darker gray for cards/sections
  const cardBg = '#1c1c1c';
  // Standard text color
  ...
  return (
    // Main container uses the darker background and flex layout
        ...
        <section className="mt-5 pt-3">
          ...
          <div className="card shadow-lg border-0" style={{ backgroundColor: cardBg }}>
            <ul className="list-group list-group-flush">
              {/* Note: I'm using bg-transparent and border-dark to integrate better with the card */}
